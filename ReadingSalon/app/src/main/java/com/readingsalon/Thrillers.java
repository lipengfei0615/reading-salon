...
public class Thrillers extends AppCompatActivity{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.thrillers);
        getSupportActionBar().setDisplayUseLogoEnabled(true);
        getSupportActionBar().setDisplayShowTitleEnabled(true);
        getSupportActionBar().setDisplayShowHomeEnabled(true);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        mContext = Thrillers.this;
        init();
    ...
    private void init() {
        ...
        list_book = (ListView) findViewById(R.id.thrillers);

        //数据初始化

        mData = new ArrayList<Book>();

        mData.add(new Book("The Screwtape Letters"));
